    ...
    <div className='bg-[#f6f6f6] w-[80%] h-auto mx-auto'>
            ...
            <div className='w-full h-full justify-center items-center flex flex-col lg:flex-row'>
                <div className="bg-gray-200 lg:mt-0 lg:mb-0 rounded-full overflow-hidden blob z-20 w-[250px] h-[250px] sm:w-[350px] sm:h-[350px] md:w-[450px] md:h-[450px] lg:w-[420px] lg:h-[420px] xl:w-[500px] xl:h-[500px] px-5 overflow flex justify-center items-center mx-auto relative">
                    <img src={tony} alt="#!" className='sm:mt-12 md:mt-12 lg:mt-5 xl:mt-16 mx-auto w-[250px] h-[250px] sm:w-[300px] sm:h-[300px] md:w-[400px] md:h-[400px] lg:h-[400px] lg:w-[450px] xl:h-[450px] xl:w-[450px] z-10'/>
                </div>
                <div className='w-[50%] flex justify-between flex-col'>
                    <div className='text-center lg:text-start lg:text-xl'>
                    <p className='mb-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                    <p className='mb-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit Lorem.</p>
