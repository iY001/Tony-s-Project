...
function Intro() {
    return (
        <div className="container flex-col-reverse lg:flex-row justify-center items-center h-auto mx-auto text-lg flex relative">
            <div data-aos="fade-right" data-aos-duration={1000} className="w-full px-5 lg:px-0 lg:w-1/2 h-full items-center flex mb-5 justify-center lg:items-start flex-col lg:">
                ...
                <p className="text-center lg:text-start">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Necessitatibus
                    deleniti asperiores debitis vel,
                    quibusdam assumenda sapiente! Officia consequatur sint iste vero, minima fugiat, repellendus adipisci
                    libero quidem officiis voluptas qui.</p>
            ...
            <div data-aos="fade-left" data-aos-duration={1000} className="mb-5  lg:mb-0 rounded-full overflow-hidden blob z-[-2] w-[350px] h-[350px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px] px-5 overflow flex justify-center items-center mx-auto relative bg-[#FD5956]">
                <div className="rounded-full w-[300px] h-[300px] md:w-[400px] md:h-[400px] lg:w-[450px] lg:h-[450px] bg-[#f57573] absolute" />
                <div className="rounded-full w-[250px] h-[250px] md:w-[350px] md:h-[350px] lg:w-[400px] lg:h-[400px] bg-[#fa9795] absolute" />
                <img src={tony} className="w-[400px] h-[350px] md:w-[400px] z-10 md:h-[400px] mr-10 lg:h-[450px] " alt="!#"/>
                <img src={over} className="w-full h-[200px] z-10 absolute bottom-0" alt="#!" />
            </div>
        </div>
