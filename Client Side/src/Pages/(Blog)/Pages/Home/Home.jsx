...
function Home() {
  ...
  return (
    <div className='lg:w-9/12  w-full mx-auto bg-[#181A2A] dark:bg-white'>
      <div className='container bg-white   '>


        <div className={`navbar   max-lg:dark:bg-[#F4F4F5] md:absolute md:mr-10 w-full flex max-sm:flex-wrap  justify-between   max-sm:gap-2 max-lg:py-4 ${!openMenue?'max-lg:shadow-md':'max-lg:shadow-none'}   lg:my-8 items-center dark:text-black `}>
          ...
          <div className={`navLinks max-lg:absolute max-lg:shadow-md max-lg:h-[230px] md:h-[300px]  max-lg:w-full ${openMenue?'max-lg:block':'max-lg:hidden'} max-lg:-z-10 md:-top-[58px]  max-lg:-top-2 duration-200 max-lg:dark:bg-[#F4F4F5]  max-lg:text-left max-lg:translate-y-[130px]`}>
